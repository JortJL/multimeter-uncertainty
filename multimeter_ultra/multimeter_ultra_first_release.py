...
class rekenwerk:
    def pw_µA_DC():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel micro Ampere heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 4000:
            D = 0.001 * C + 4 * 0.1
        ...
        showinfo(
            "de onzekerheid",
            "de onzekerheid bij de gemeten eenheid is: ({}".format(C)
            + " ± {}".format(D)
            + ") µA",
        )
    ...
    def pw_mA_DC():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel mili Ampere heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 4:
            D = 0.001 * C + 4 * 0.0001
    ...
    def pw_Am_DC():
        ws.title("gemeten waarde")
        C = float(
            simpledialog.askstring("Input", "hoeveel Ampere heb je gemeten?", parent=ws)
        )
        if C > 0 and C <= 0.004:
    ...
    def pw_µV_DC():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel micro Volt heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 400000:
            D = 0.0008 * C + 4 * 10
    ...
    def pw_mV_DC():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel mili Volt heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 400:
            D = 0.0008 * C + 4 * 0.01
    ...
    def pw_Vm_DC():
        ws.title("gemeten waarde")
        C = float(
            simpledialog.askstring("Input", "hoeveel Volt heb je gemeten?", parent=ws)
        )
        if C > 0 and C <= 0.4:
    ...
    def pw_µV_AC():
        ws.title("Hertz?")
        C = float(
            simpledialog.askstring("Input", "hoeveel Hertz heb je gemeten?", parent=ws)
        )
        if C > 45 and C <= 400:
            C = float(
                simpledialog.askstring(
    ...
    def pw_Vm_AC():
        ...
        if C > 45 and C <= 400:
            C = float(
                simpledialog.askstring(
                    "Input", "hoeveel Volt heb je gemeten?", parent=ws
                )
            )
            if C > 0 and C <= 0.4:
                D = 0.005 * C + 4 * 0.0001
    ...
    def popup_win_mR():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel mili Ohm heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 400000:
            D = 0.0015 * C + 6 * 10
    ...
    def popup_win_Rm():
        ws.title("gemeten waarde")
        C = float(
            simpledialog.askstring("Input", "hoeveel Ohm heb je gemeten?", parent=ws)
        )
        if C > 0 and C <= 400:
            D = 0.0015 * C + 6 * 0.01
        elif C > 400 and C <= 4000:
    ...
    def popup_win_kR():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel kilo Ohm heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 0.4:
    ...
    def popup_win_MR():
        ...
        C = float(
            simpledialog.askstring(
                "Input", "hoeveel Mega Ohm heb je gemeten?", parent=ws
            )
        )
        if C > 0 and C <= 0.0004:
...
class DMM1:
    ws.title(
        "DMM onzekerheid berekenen, door Jort Joris Leroij   Technische Natuurkunde - hhs Delft"
    )
    ...
    def pw_A_DC():
        ...
        DMM1.button_µA = Button(
            ws, text="µA", style="W.TButton", command=rekenwerk.pw_µA_DC
        )
        DMM1.button_mA = Button(
            ws, text="mA", style="W.TButton", command=rekenwerk.pw_mA_DC
        )
        DMM1.button_A = Button(
            ws, text="A", style="W.TButton", command=rekenwerk.pw_Am_DC
        )
    ...
    def pw_A_AC():
        ...
        DMM1.button_µA = Button(
            ws, text="µA", style="W.TButton", command=rekenwerk.pw_µA_AC
        )
        DMM1.button_mA = Button(
            ws, text="mA", style="W.TButton", command=rekenwerk.pw_mA_AC
        )
        DMM1.button_A = Button(
            ws, text="A", style="W.TButton", command=rekenwerk.pw_Am_AC
        )
    ...
    def pw_V_DC():
        ...
        DMM1.button_µU = Button(
            ws, text="µV", style="W.TButton", command=rekenwerk.pw_µV_DC
        )
        DMM1.button_mU = Button(
            ws, text="mV", style="W.TButton", command=rekenwerk.pw_mV_DC
        )
        DMM1.button_U = Button(
            ws, text="V", style="W.TButton", command=rekenwerk.pw_Vm_DC
        )
    ...
    def pw_V_AC():
        ...
        DMM1.button_µU = Button(
            ws, text="µV", style="W.TButton", command=rekenwerk.pw_µV_AC
        )
        DMM1.button_mU = Button(
            ws, text="mV", style="W.TButton", command=rekenwerk.pw_mV_AC
        )
        DMM1.button_U = Button(
            ws, text="V", style="W.TButton", command=rekenwerk.pw_Vm_AC
        )
    ...
    def pw_R():
        ...
        DMM1.button_mΩ = Button(
            ws, text="mΩ", style="W.TButton", command=rekenwerk.popup_win_mR
        )
        DMM1.button_Ω = Button(
            ws, text="Ω", style="W.TButton", command=rekenwerk.popup_win_Rm
        )
        DMM1.button_kΩ = Button(
            ws, text="kΩ", style="W.TButton", command=rekenwerk.popup_win_kR
        )
        DMM1.button_MΩ = Button(
            ws, text="MΩ", style="W.TButton", command=rekenwerk.popup_win_MR
        )
    ...
    def startknoppen():
        ...
        Button(ws, text="Amperage (DC)", style="W.TButton", command=DMM1.pw_A_DC).pack(
            pady=10
        )
        Button(ws, text="Amperage (AC)", style="W.TButton", command=DMM1.pw_A_AC).pack(
            pady=10
        )
        Button(
            ws, text="voltage      (DC)", style="W.TButton", command=DMM1.pw_V_DC
        ).pack(pady=10)
        Button(
            ws, text="voltage      (AC)", style="W.TButton", command=DMM1.pw_V_AC
        ).pack(pady=10)
        Button(ws, text="weerstand        ", style="W.TButton", command=DMM1.pw_R).pack(
            pady=10
        )
